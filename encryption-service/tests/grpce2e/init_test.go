...
var protoUserScopes = []users.UserScope{users.UserScope_READ, users.UserScope_CREATE, users.UserScope_UPDATE, users.UserScope_INDEX, users.UserScope_OBJECTPERMISSIONS}
