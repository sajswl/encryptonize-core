...
func AuthorizeWrapper(ctx context.Context, accessObjectMAC interfaces.MessageAuthenticatorInterface, objectIDString string) (*authz.Authorizer, *authz.AccessObject, error) {
